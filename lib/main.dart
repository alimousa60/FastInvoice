...
String fixPdfArabic(String text) {
  ...
  const Map<int, List<int>> _forms = {
    ...
    0x0621: [0xFE8D, 0xFE8D, 0xFE8D, 0xFE8D],

    0x0622: [0xFE8F, 0xFE90, 0xFE91, 0xFE92],
    ...
    0x0640: [0xFE70, 0xFE70, 0xFE71, 0xFE72],
    ...
    0x0649: [0xFEEF, 0xFEF0, 0xFEF1, 0xFEF2],
  ...
  bool _isArabic(int c) => (c >= 0x0600 && c <= 0x06FF) || (c >= 0x0750 && c <= 0x077F) || (c >= 0x08A0 && c <= 0x08FF) || (c >= 0xFB50 && c <= 0xFDFF) || (c >= 0xFE70 && c <= 0xFEFF);

  bool _isJoining(int c) {

    if (!_isArabic(c)) return false;

    if (c == 0x0621 || c == 0x0622 || c == 0x0623 || c == 0x0624 || c == 0x0625 || c == 0x0627 || c == 0x0629 || c == 0x062F || c == 0x0630 || c == 0x0631 || c == 0x0632 || c == 0x0648) return false;
